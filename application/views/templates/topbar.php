				...
				<li class="nav-item dropdown no-arrow mx-1">
					<a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<span class="badge badge-danger badge-counter">
							<!-- <?= $this->Data_model->jmldata(['alkohol' >= 4])->num_rows(); ?> -->
							<!-- <?= $this->Data_model->jmldata(['status' => 1])->num_rows(); ?> -->
							<?= $this->Data_model->notifikasiTopBar()->num_rows(); ?>
						</span>
					</a>
					...
					<div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
						...
						<div class="scrollable-content"> <!-- Tambahkan wrapper dengan class "scrollable-content" -->
							<?php foreach ($nyoba as $n) : ?>
								<?php if ($n['status'] == 1 || $n['alkohol'] > 4) : ?>
									<a class="dropdown-item d-flex align-items-center" href="">
										<div class="mr-3">
											<?php if ($n['suhu'] > 41) {
											...
											<?php if ($n['suhu'] < 41) {
												echo '	<div class="icon-circle bg-dark">
												<i class="fas fa-file-alt text-white"></i>
											</div>';
											} ?>
										...
										<div class="font-weight-bold">
											...
											<div>
												...
												<?php if ($n['suhu'] > 40) {
													echo '<span class="badge badge-danger">Suhu Terlalu Panas</span>';
												} ?>
						...
						<?php
						$numRows = $this->Data_model->notifikasiTopBar()->num_rows(); // Mengambil jumlah baris dari notifikasiTopBar()
						...
						?>
							<a class="dropdown-item d-flex align-items-center" href="javascript:voind(0)">
