...
class Admin extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['jmlAlkohol'] = $this->Data_model->jmlAlkohol();
		$data['hasilProduksi'] = $this->Data_model->hasilProduksi();
	...
	public function checkDirectoryPermission()
	{
		...
		if (is_writable($directory)) {
			echo "Direktori dapat ditulisi.";
		} else {
			echo "Tidak dapat menulis ke direktori.";
		}
	}
	...
	public function get_alkohol()
	{
		$dataAlkohol = $this->Data_model->getAlkoholData();
		echo json_encode($dataAlkohol);
	}
}
