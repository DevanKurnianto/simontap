                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?= base_url('autentifikasi/register') ?>" class="badge badge-danger" onclick="return confirm('Silahkan Menghubungi Admin Untuk Reset Pasword!!');">Lupa
                                    Password?</a>
                            </div>
                            <div class="text-center">
