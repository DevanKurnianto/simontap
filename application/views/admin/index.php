...
function realtime() {
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#suhu').html(response.data.suhu + ' <sup style="font-size: 15px"> o</sup>C');
            $('#udara').html(response.data.udara + ' %');
            $('#berat').html(response.data.berat + ' Gram');
            $('#alkohol').html(response.data.alkohol + ' %');
